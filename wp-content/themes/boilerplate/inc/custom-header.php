 ...
 * @uses boilerplate_admin_header_style()
 * @uses boilerplate_admin_header_image()
 */
function boilerplate_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'boilerplate_custom_header_args', array(
		...
		'admin-preview-callback' => 'boilerplate_admin_header_image',
	) ) );
}
...
endif; // boilerplate_header_style
...
endif; // boilerplate_admin_header_style

if ( ! function_exists( 'boilerplate_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see boilerplate_custom_header_setup().
 */
function boilerplate_admin_header_image() {
...
endif; // boilerplate_admin_header_image